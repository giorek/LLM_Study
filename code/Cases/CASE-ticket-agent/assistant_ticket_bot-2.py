...
font_path = '/System/Library/Fonts/PingFang.ttc'  # Mac 下 PingFang 字体路径
my_font = fm.FontProperties(fname=font_path)

plt.bar(['一日门票', '二日门票'], [0, 0])
plt.title('门票销量统计', fontproperties=my_font)
plt.xlabel('门票类型', fontproperties=my_font)
